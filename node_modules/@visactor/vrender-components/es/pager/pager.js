...
export class Pager extends AbstractComponent {
    ...
    render() {
        ...
        const {width: maxTextWidth, height: maxTextHeight} = measureTextSize(`${total}/${total}`, Object.assign({
            textAlign: "center",
            textBaseline: "middle"
        }, textStyle), null === (_b = this.stage) || void 0 === _b ? void 0 : _b.getTheme().text.fontFamily), handlerSizeX = isNumber(handlerSize) ? handlerSize : handlerSize[0], handlerSizeY = isNumber(handlerSize) ? handlerSize : handlerSize[1], text = graphicCreator.text(Object.assign({
