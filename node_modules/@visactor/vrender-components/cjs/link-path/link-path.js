...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.LinkPath = exports.getVerticalPath = exports.getHorizontalPath = void 0;

const vutils_1 = require("@visactor/vutils"), base_1 = require("../core/base"), register_1 = require("./register"), getHorizontalPath = (options, ratio) => {
...
exports.getVerticalPath = getVerticalPath, (0, register_1.loadLinkPathComponent)();

class LinkPath extends base_1.AbstractComponent {
    constructor(attributes, options) {
        super((null == options ? void 0 : options.skipDefault) ? attributes : (0, vutils_1.merge)({}, LinkPath.defaultAttributes, attributes));
    }
    render() {
        const {direction: direction = "horizontal"} = this.attribute, parsePath = "vertical" === direction ? exports.getVerticalPath : exports.getHorizontalPath, isRatioShow = "number" == typeof this.attribute.ratio && this.attribute.ratio >= 0 && this.attribute.ratio <= 1, groupAttrKeys = [ "direction", "x0", "x1", "y0", "y1", "thickness", "round", "ratio", "align", "isSmooth", "backgroudStyle" ], commonStyle = {};
