...
const vutils_1 = require("@visactor/vutils"), base_1 = require("./base"), vrender_core_1 = require("@visactor/vrender-core"), util_1 = require("./util");
...
class ArcLabel extends base_1.LabelBase {
    constructor(attributes, options) {
        super((null == options ? void 0 : options.skipDefault) ? attributes : (0, vutils_1.merge)({}, ArcLabel.defaultAttributes, attributes)), 
