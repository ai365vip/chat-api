...
class Title extends base_1.AbstractComponent {
    ...
    render() {
        ...
        if (!1 !== this.attribute.visible && !1 !== textStyle.visible) if ("rich" === textType || (0, 
        ...
        if (!1 !== this.attribute.visible && !1 !== subtextStyle.visible) if ("rich" === subtextType || (0, 
        ...
        if ((0, vutils_1.isValid)(width) && (titleWidth = width, this._mainTitle && this._mainTitle.setAttribute("maxLineWidth", width), 
        this._subTitle && this._subTitle.setAttribute("maxLineWidth", width)), (0, vutils_1.isValid)(height) && (titleHeight = height), 
        (0, vutils_1.isValid)(minWidth) && titleWidth < minWidth && (titleWidth = minWidth), 
        (0, vutils_1.isValid)(maxWidth) && (this._mainTitle && this._mainTitle.setAttribute("maxLineWidth", maxWidth), 
        ...
        (0, vutils_1.isValid)(maxHeight) && (this._mainTitle && this._mainTitle.setAttribute("maxHeight", maxHeight), 
