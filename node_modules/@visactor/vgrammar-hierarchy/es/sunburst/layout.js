...
export class SunburstLayout {
    ...
    _parseRadius(viewBox, maxDepth) {
        ...
        if (isInnerArray) this._parsedInnerRadius = rangeArr.map(((entry, index) => {
            ...
            var _a;
            return isOuterArray ? parsedOuterRadius[index] : index < maxDepth ? this._parsedInnerRadius[index + 1] - (isArray(gapRadius) ? null !== (_a = gapRadius[index]) && void 0 !== _a ? _a : 0 : gapRadius) : parsedOuterRadius;
