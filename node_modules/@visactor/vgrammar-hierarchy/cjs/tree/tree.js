...
const utils_1 = require("../utils"), vutils_1 = require("@visactor/vutils");
...
function tidyTree(root, viewBox, minNodeGap, linkWidth, separation = defaultSeparation) {
    ...
    })), t.parent.m = -t.z, (0, utils_1.eachBefore)([ t ], (v => {
    ...
    if ((0, vutils_1.isNumber)(minNodeGap) && getY) {
        ...
        (0, utils_1.eachBefore)([ root ], setSizeOfNode);
    } else {
