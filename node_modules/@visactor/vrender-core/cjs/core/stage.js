...
const vutils_1 = require("@visactor/vutils"), window_1 = require("./window"), event_1 = require("../event"), container_1 = require("../container"), render_1 = require("../render"), graphic_1 = require("../graphic"), constants_1 = require("../picker/constants"), constants_2 = require("../plugins/constants"), auto_render_plugin_1 = require("../plugins/builtin-plugin/auto-render-plugin"), _3dview_transform_plugin_1 = require("../plugins/builtin-plugin/3dview-transform-plugin"), incremental_auto_render_plugin_1 = require("../plugins/builtin-plugin/incremental-auto-render-plugin"), html_attribute_plugin_1 = require("../plugins/builtin-plugin/html-attribute-plugin"), dirty_bounds_plugin_1 = require("../plugins/builtin-plugin/dirty-bounds-plugin"), flex_layout_plugin_1 = require("../plugins/builtin-plugin/flex-layout-plugin"), default_ticker_1 = require("../animate/default-ticker"), tapable_1 = require("../tapable"), light_1 = require("./light"), camera_1 = require("./camera"), constants_3 = require("./constants"), animate_1 = require("../animate"), application_1 = require("../application"), env_check_1 = require("../env-check"), DefaultConfig = {
    WIDTH: 500,
    HEIGHT: 500,
    X: 0,
    Y: 0,
...
class Stage extends graphic_1.Group {
    ...
    enableLayout() {
        this._enableLayout || (this._enableLayout = !0, this.pluginService.register(new flex_layout_plugin_1.FlexLayoutPlugin));
    }
    disableLayout() {
    ...
    pick(x, y) {
        this.pickerService || (this.pickerService = container_1.container.get(constants_1.PickerService));
    ...
    renderToNewWindow(fullImage = !0, viewBox) {
        const window = container_1.container.get(window_1.VWindow);
