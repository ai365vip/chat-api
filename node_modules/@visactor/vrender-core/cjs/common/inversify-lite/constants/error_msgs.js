...
exports.UNDEFINED_INJECT_ANNOTATION = UNDEFINED_INJECT_ANNOTATION, exports.CIRCULAR_DEPENDENCY = "Circular dependency found:", 
exports.NOT_IMPLEMENTED = "Sorry, this feature is not fully implemented yet.", exports.INVALID_BINDING_TYPE = "Invalid binding type:", 
exports.NO_MORE_SNAPSHOTS_AVAILABLE = "No snapshot available to restore.", exports.INVALID_MIDDLEWARE_RETURN = "Invalid return type in middleware. Middleware must return!", 
exports.INVALID_FUNCTION_BINDING = "Value provided to function binding must be a function!";

const LAZY_IN_SYNC = key => `You are attempting to construct '${key}' in a synchronous way\n but it has asynchronous dependencies.`;

exports.LAZY_IN_SYNC = LAZY_IN_SYNC, exports.INVALID_TO_SELF_VALUE = "The toSelf function can only be applied when a constructor is used as service identifier", 
...
const ARGUMENTS_LENGTH_MISMATCH = (...values) => `The number of constructor arguments in the derived class ${values[0]} must be >= than the number of constructor arguments of its base class.`;

exports.ARGUMENTS_LENGTH_MISMATCH = ARGUMENTS_LENGTH_MISMATCH, exports.CONTAINER_OPTIONS_MUST_BE_AN_OBJECT = "Invalid Container constructor argument. Container options must be an object.", 
...
exports.CIRCULAR_DEPENDENCY_IN_FACTORY = CIRCULAR_DEPENDENCY_IN_FACTORY, exports.STACK_OVERFLOW = "Maximum call stack size exceeded";
