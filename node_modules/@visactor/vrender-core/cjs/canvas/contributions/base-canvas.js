...
const inversify_lite_1 = require("../../common/inversify-lite"), DefaultConfig = {
    WIDTH: 500,
    HEIGHT: 500,
    DPR: 1
};
...
BaseCanvas.env = "browser", BaseCanvas = __decorate([ (0, inversify_lite_1.injectable)(), __metadata("design:paramtypes", [ Object ]) ], BaseCanvas), 
