...
let DefaultCanvasAreaRender = class extends base_render_1.BaseRender {
    ...
    _drawSegmentItem(context, cache, fill, fillOpacity, stroke, strokeOpacity, attribute, defaultAttribute, clipRange, offsetX, offsetY, offsetZ, area, drawContext, connect, fillCb, strokeCb) {
        ...
        const da = [];
        if (connect && ((0, vutils_1.isArray)(defaultAttribute) ? (connectedType = null !== (_a = null != connectedType ? connectedType : defaultAttribute[0].connectedType) && void 0 !== _a ? _a : defaultAttribute[1].connectedType, 
        ...
        (0, vutils_1.isArray)(defaultAttribute) ? defaultAttribute.forEach((i => da.push(i))) : da.push(defaultAttribute), 
        ...
        direction = (0, vutils_1.abs)(endP.x - startP.x) > (0, vutils_1.abs)(endP.y - startP.y) ? enums_1.Direction.ROW : enums_1.Direction.COLUMN, 
