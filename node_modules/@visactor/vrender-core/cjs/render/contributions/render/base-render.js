...
const graphic_1 = require("../../../graphic"), matrix_allocate_1 = require("../../../allocator/matrix-allocate"), utils_1 = require("./utils"), enums_1 = require("../../../common/enums"), result = {
    x: 0,
    y: 0,
    z: 0,
...
class BaseRender {
    ...
    transform(graphic, graphicAttribute, context, use3dMatrixIn3dMode = !1) {
        ...
        const shouldTransform3d = camera && (use3dMatrixIn3dMode || (0, graphic_1.shouldUseMat4)(graphic)), onlyTranslate = shouldTransform3d ? graphic.transMatrix.onlyTranslate() && !postMatrix : 1 === scaleX && 1 === scaleY && 0 === angle && !postMatrix;
    ...
    _draw(graphic, defaultAttr, computed3dMatrix, drawContext, params) {
        ...
        this.z = z, (0, utils_1.drawPathProxy)(graphic, context, x, y, drawContext, params) || (this.drawShape(graphic, context, x, y, drawContext, params), 
