...
import { Logger, degreeToRadian, isFunction, isNil, maxInArray, toNumber } from "@visactor/vutils";
...
export const transform = (options, upstreamData, parameters, view) => __awaiter(void 0, void 0, void 0, (function*() {
    var _a, _b, _c;
    ...
    options.size = [ Math.ceil(options.size[0]), Math.ceil(options.size[1]) ], options.shape || error("WordcloudShape shape must be specified."), 
    ...
    const {fillingWords: fillingWords, successedWords: successedWords, failedWords: failedWords} = cloud(words, layoutConfig, segmentationOutput);
    let w, t;
    const modKeywords = [];
    ...
    t[as.visible] = w.visible, t[as.isFillingWord] = !1, t[as.color] = w.color, modKeywords.push(t);
