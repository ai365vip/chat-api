...
let BrowserCanvas = class extends vrender_core_1.BaseCanvas {
    constructor(params) {
        super(params);
    }
    init(params) {
        ...
        if ("string" == typeof container) {
            const _c = vrender_core_1.application.global.getElementById(container);
...
BrowserCanvas.env = "browser", BrowserCanvas = __decorate([ (0, vrender_core_1.injectable)(), __metadata("design:paramtypes", [ Object ]) ], BrowserCanvas), 
