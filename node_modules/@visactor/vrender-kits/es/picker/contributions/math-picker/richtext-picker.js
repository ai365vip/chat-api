...
DefaultMathRichTextPicker = __decorate([ injectable(), __param(0, inject(RichTextRender)), __metadata("design:paramtypes", [ Object ]) ], DefaultMathRichTextPicker);

export { DefaultMathRichTextPicker };
