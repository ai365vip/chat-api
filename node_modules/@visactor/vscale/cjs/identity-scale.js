...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.IdentityScale = exports.implicit = void 0;
...
class IdentityScale {
    constructor() {
        this.type = type_1.ScaleEnum.Identity;
    }
    specified(_) {
        var _a;
    ...
    scale(d) {
        ...
        return void 0 !== special ? special : this._unknown !== exports.implicit && this._domain && !this._domain.includes(d) ? this._unknown : d;
    }
    invert(d) {
        return d;
    }
