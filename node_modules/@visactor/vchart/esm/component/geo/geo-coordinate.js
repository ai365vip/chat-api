...
export class GeoCoordinate extends BaseComponent {
    ...
    coordinateHelper() {
        ...
        this._regions.forEach((r => {
            r.getSeries().forEach((s => {
                s.type === SeriesTypeEnum.map ? s.setCoordinateHelper(helper) : (s.setXAxisHelper(Object.assign(Object.assign({}, helper), {
                    isContinuous: !0,
    ...
    collectFeatures() {
        ...
        return this._regions.forEach((r => {
            r.getSeries().forEach((s => {
                var _a, _b;
                s.type === SeriesTypeEnum.map && features.push(...null !== (_b = null === (_a = s.getMapViewData()) || void 0 === _a ? void 0 : _a.latestData) && void 0 !== _b ? _b : []);
            }));
        })), features;
    }
