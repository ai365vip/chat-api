...
export class CartesianCrossHair extends BaseCrossHair {
    ...
    layoutByValue(tag = LayoutType.ALL) {
        ...
        tag && (LayoutType.HORIZONTAL && this._layoutHorizontal(yCrossHairInfo, null != valueHeight ? valueHeight : 0, offsetHeight), 
        LayoutType.VERTICAL && this._layoutVertical(xCrossHairInfo, null != indexWidth ? indexWidth : 0, offsetWidth)), 
