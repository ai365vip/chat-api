...
export class VChart {
    ...
    constructor(spec, options) {
        ...
        this._compiler.initView(), null === (_d = this.getStage()) || void 0 === _d || _d.setTheme({
            text: {
    ...
    _initChartSpec(spec, actionSource) {
        ...
        this._spec = spec, this._chartSpecTransformer || (this._chartSpecTransformer = Factory.createChartSpecTransformer(this._spec.type, {
    ...
    _updateSpecInfo() {
        var _a;
        this._chartSpecTransformer || (this._chartSpecTransformer = Factory.createChartSpecTransformer(this._spec.type, {
            type: this._spec.type,
            getTheme: () => {
                var _a;
                return null !== (_a = this._currentTheme) && void 0 !== _a ? _a : {};
    ...
    updateData(id, data, options) {
        return __awaiter(this, void 0, void 0, (function*() {
            if (isNil(this._dataSet)) return this;
            ...
            return preDV ? preDV.id === id ? preDV.values = data : preDV.name === id && preDV.parse(data, options) : isArray(data) ? this._spec.data.push({
                id: id,
                values: data
    ...
    resize(width, height) {
        ...
        return __awaiter(this, void 0, void 0, (function*() {
            ...
            this._isReleased || this._event.emit(ChartEvent.afterResize, {
                chart: this._chart
            }), this);
        }));
    }
    ...
    _shouldChartResize(oldSpec) {
        var _a, _b;
        let resize = !1;
        isNil(this._spec.width) ? this._spec.width = oldSpec.width : this._spec.width !== oldSpec.width && (resize = !0), 
        isNil(this._spec.height) ? this._spec.height = oldSpec.height : this._spec.height !== oldSpec.height && (resize = !0);
    ...
    getLegendDataByIndex(index = 0) {
        var _a;
        const legends = null === (_a = this._chart) || void 0 === _a ? void 0 : _a.getAllComponents().filter((c => c.type === ComponentTypeEnum.discreteLegend));
    ...
    getContainer() {
        ...
        let canvasNode;
        return canvasNode = isString(this._canvas) ? null === document || void 0 === document ? void 0 : document.getElementById(this._canvas) : this._canvas, 
    ...
    convertDatumToPosition(datum, dataLinkInfo = {}, isRelativeToCanvas = !1) {
        ...
        series) {
            ...
            convertPoint(point, seriesLayoutStartPoint, isRelativeToCanvas);
        }
        return null;
    }
...
export const registerVChartCore = () => {
    ...
    registerGroupMark(), View.useRegisters([ registerFilterTransform, registerMapTransform ]), 
    registerVGrammarCommonAnimation(), registerTheme(darkTheme.name, darkTheme), Logger.getInstance(LoggerLevel.Error);
};
