    ...
    constructor(tooltipId, component) {
        ...
        this.showTooltip = (activeType, data, params) => {
            ...
            if ((0, vutils_1.isObject)(position)) {
                ...
                left = (0, position_2.getActualTooltipPositionValue)(posLeft, event), top = (0, 
                position_2.getActualTooltipPositionValue)(posTop, event), right = (0, position_2.getActualTooltipPositionValue)(posRight, event), 
                bottom = (0, position_2.getActualTooltipPositionValue)(posBottom, event);
            } else if ((0, vutils_1.isValid)(position) && positionMode !== position_1.TooltipPositionMode.pointer && "mark" === actualTooltip.activeType) {
                isFixedPosition = !0;
                ...
                if (bounds && startPoint) {
                    ...
                    (0, position_2.getHorizontalPositionType)(position)) {
                      case "left":
                    ...
                    switch ((0, position_2.getVerticalPositionType)(position)) {
                      case "top":
            ...
            if ((0, vutils_1.isValidNumber)(left)) x = left; else if ((0, vutils_1.isValidNumber)(right)) x = canvasWidth - tooltipBoxWidth * tooltipSizeScale - right; else {
                const x0 = canvasX;
                switch ((0, position_2.getHorizontalPositionType)(position, "right")) {
                  case "middle":
            ...
            if ((0, vutils_1.isValidNumber)(top)) y = top; else if ((0, vutils_1.isValidNumber)(bottom)) y = canvasHeight - tooltipBoxHeight * tooltipSizeScale - bottom; else {
                const y0 = canvasY;
                switch ((0, position_2.getVerticalPositionType)(position, "bottom")) {
                  case "middle":
            ...
            const {width: containerWidth, height: containerHeight} = containerSize, isLeftOut = () => x * tooltipParentElementScale + tooltipParentElementRect.x < 0, isRightOut = () => (x + tooltipBoxWidth) * tooltipParentElementScale + tooltipParentElementRect.x > containerWidth, isTopOut = () => y * tooltipParentElementScale + tooltipParentElementRect.y < 0, isBottomOut = () => (y + tooltipBoxHeight) * tooltipParentElementScale + tooltipParentElementRect.y > containerHeight, detectLeftFirst = () => {
                ...
                position_2.getHorizontalPositionType)(position, "right") ? x += offsetX + tooltipBoxWidth / 2 : x += 2 * offsetX + tooltipBoxWidth);
            }, detectLeftLast = () => {
                ...
                position_2.getVerticalPositionType)(position, "bottom") ? y += offsetY + tooltipBoxHeight / 2 : y += 2 * offsetY + tooltipBoxHeight);
            }, detectTopLast = () => {
