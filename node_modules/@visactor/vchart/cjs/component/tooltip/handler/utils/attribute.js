...
const vutils_1 = require("@visactor/vutils"), merge_spec_1 = require("../../../../util/spec/merge-spec"), space_1 = require("../../../../util/space"), constants_1 = require("../../../../theme/builtin/common/constants"), common_1 = require("./common"), DEFAULT_TEXT_ATTRIBUTES = {
...
const getTooltipAttributes = (actualTooltip, spec, globalTheme) => {
    ...
    if (hasContent) {
        ...
        attributes.content = filteredContent.map(((item, i) => {
            ...
            if ((0, vutils_1.isValid)(actualKey)) {
                const itemKeyStyle = (0, merge_spec_1.mergeSpec)({}, keyStyle, getTextAttributes(actualKeyStyle, void 0, {})), {width: width, height: height, text: text} = (0, 
            ...
            if ((0, vutils_1.isValid)(actualValue)) {
                const itemValueStyle = (0, merge_spec_1.mergeSpec)({}, valueStyle, getTextAttributes(actualValueStyle, void 0, {})), {width: width, height: height, text: text} = (0, 
    ...
    if (actualTitleVisible) {
        titleValueStyle = (0, merge_spec_1.mergeSpec)({}, titleStyle, getTextAttributes(actualTitleValueStyle, void 0, {})), 
