...
const plugin_service_1 = require("../../plugin/components/plugin-service"), vutils_1 = require("@visactor/vutils"), constant_1 = require("../../constant"), animate_manager_1 = require("../../animation/animate-manager"), layout_model_1 = require("../../model/layout-model"), base_component_transformer_1 = require("./base-component-transformer");
...
class BaseComponent extends layout_model_1.LayoutModel {
    ...
    created() {
        this.initLayout(), super.created(), this.pluginService = new plugin_service_1.ComponentPluginService(this);
    }
    ...
    clear() {
        ...
        components && components.length && components.forEach((c => {
            ...
            c = null);
        })), this._container = null, null === (_a = this.pluginService) || void 0 === _a || _a.disposeAll(), 
