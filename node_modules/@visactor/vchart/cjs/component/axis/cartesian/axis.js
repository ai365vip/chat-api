...
class CartesianAxis extends base_axis_1.AxisComponent {
    ...
    static getSpecInfo(chartSpec) {
        ...
        const isHorizontal = chartSpec.direction === space_1.Direction.horizontal;
    ...
    updateScaleRange() {
        ...
        let newRange = [];
        (0, common_1.isXAxis)(this.getOrient()) ? (0, util_1.isValidNumber)(width) && (newRange = this._inverse ? [ width, 0 ] : [ 0, width ]) : (0, 
        common_1.isZAxis)(this.getOrient()) ? (0, util_1.isValidNumber)(width) && (newRange = this._inverse ? [ width, 0 ] : [ 0, width ], 
        this._scale.range(newRange)) : (0, util_1.isValidNumber)(height) && (newRange = this._inverse ? [ 0, height ] : [ height, 0 ]);
    ...
    setAttrFromSpec() {
        ...
        this._inverse = (0, common_1.transformInverse)(this._spec, (null == chartSpec ? void 0 : chartSpec.direction) === space_1.Direction.horizontal);
    }
    ...
    collectData(depth, rawData) {
        ...
        return (0, util_1.eachSeries)(this._regions, (s => {
            var _a, _b, _c;
            let field;
            field = depth > 0 ? null === (_b = null === (_a = s.getGroups()) || void 0 === _a ? void 0 : _a.fields) || void 0 === _b ? void 0 : _b[depth] : (0, 
            ...
            field && field.forEach((f => {
                var _a;
                rawData ? data.push(s.getRawDataStatisticsByField(f, !1)) : (null === (_a = null == seriesData ? void 0 : seriesData.latestData) || void 0 === _a ? void 0 : _a[f]) && data.push(seriesData.latestData[f]);
            }));
        }), {
            userId: this._seriesUserId,
            specIndex: this._seriesIndex
