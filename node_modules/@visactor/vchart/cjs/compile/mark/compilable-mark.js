...
const grammar_item_1 = require("../grammar-item"), vutils_1 = require("@visactor/vutils"), constant_1 = require("../../constant"), util_1 = require("./util"), mark_state_manager_1 = require("./mark-state-manager"), interface_1 = require("./interface"), mark_data_1 = require("./mark-data"), compilable_item_1 = require("../interface/compilable-item"), event_1 = require("../../event/event"), interface_2 = require("../../animation/interface");
...
class CompilableMark extends grammar_item_1.GrammarItem {
    ...
    constructor(option, name, model) {
        ...
        this.name = "mark", this._interactive = !0, this._zIndex = constant_1.LayoutZIndex.Mark, 
        this._visible = !0, this.stateStyle = {}, this._unCompileChannel = {}, this._skipBeforeLayouted = !1, 
        this._morph = !1, this.name = name, this.model = model, this.key = option.key, this.state = new mark_state_manager_1.MarkStateManager(Object.assign(Object.assign({}, option), {
        ...
        this._event = new event_1.Event(model.getOption().eventDispatcher, model.getOption().mode);
    }
    ...
    stateKeyToSignalName(key) {
        return `${constant_1.PREFIX}_${this.type}_${this.id}_${key}`;
    }
    ...
    _compileProduct(option) {
        ...
        this.compileState(), this.compileEncode(), this.compileAnimation(), this.compileContext(), 
    ...
    compileData() {
        ...
        (0, vutils_1.isValid)(this._product) && (0, vutils_1.isValid)(dataProduct) && this._product.join(dataProduct, this.key, void 0, null !== (_a = this._groupKey) && void 0 !== _a ? _a : this._facet);
    }
    updateStaticEncode() {
    ...
    _separateStyle() {
        ...
        return Object.keys(normalStyle).forEach((key => {
            this._unCompileChannel[key] || (this._option.noSeparateStyle || (0, util_1.isStateAttrChangeable)(key, normalStyle, this.getFacet()) ? updateStyles[key] = {
    ...
    compileAnimation() {
        ...
        if (this._animationConfig) {
            ...
            }), this._animationConfig.normal && this._event.on(constant_1.VGRAMMAR_HOOK_EVENT.ANIMATION_END, (({event: event}) => {
