...
const base_series_1 = require("../base/base-series"), constant_1 = require("../../constant"), space_1 = require("../../typings/space"), type_1 = require("../../util/type"), vutils_1 = require("@visactor/vutils"), vscale_1 = require("@visactor/vscale"), utils_1 = require("../util/utils");
...
class CartesianSeries extends base_series_1.BaseSeries {
    constructor() {
        ...
        }, this._direction = space_1.Direction.vertical, this._sortDataByAxis = !1, this._getInvalidDefined = datum => {
            var _a, _b;
    ...
    getStackValueField() {
        return this.direction === space_1.Direction.vertical ? (0, vutils_1.array)(this._spec.yField)[0] : (0, 
        vutils_1.array)(this._spec.xField)[0];
    }
    setValueFieldToStack() {
        this.direction === space_1.Direction.vertical ? (this.setFieldY(constant_1.STACK_FIELD_END), 
        this.setFieldY2(constant_1.STACK_FIELD_START)) : (this.setFieldX(constant_1.STACK_FIELD_END), 
        this.setFieldX2(constant_1.STACK_FIELD_START));
    }
    setValueFieldToPercent() {
        this.direction === space_1.Direction.vertical ? (this.setFieldY(constant_1.STACK_FIELD_END_PERCENT), 
    ...
    setValueFieldToStackOffsetSilhouette() {
        this.direction === space_1.Direction.vertical ? (this.setFieldY(constant_1.STACK_FIELD_END_OffsetSilhouette), 
    ...
    getDimensionField() {
        return this._direction === space_1.Direction.vertical ? this._specXField : this._specYField;
    }
    getMeasureField() {
        return this._direction === space_1.Direction.vertical ? this._specYField : this._specXField;
    }
    viewDataUpdate(d) {
    ...
    _sortDataInAxisDomain() {
        ...
        utils_1.sortDataInAxisHelper)(this._direction === space_1.Direction.horizontal ? this._yAxisHelper : this._xAxisHelper, this._direction === space_1.Direction.horizontal ? this._fieldY[0] : this._fieldX[0], this.getViewData().latestData), 
