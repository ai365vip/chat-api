...
class PolarPointUpdate extends vrender_core_1.ACustomAnimate {
    ...
    onBind() {
        ...
        (0, vutils_1.isValidNumber)(fromAngle * fromRadius) || (this.valid = !1), this._fromAngle = fromAngle, 
        this._fromRadius = fromRadius;
        const {angle: toAngle, radius: toRadius} = this._pointToCoord(this.to);
        (0, vutils_1.isValidNumber)(toAngle * toRadius) || (this.valid = !1), this._toAngle = toAngle, 
...
class PolarTagPointsUpdate extends vrender_core_1.TagPointsUpdate {
    ...
    polarPointInterpolation(pointA, pointB, ratio) {
        const polarPointA0 = this._pointToCoord(pointA), polarPointA1 = this._pointToCoord({
            ...
            angle: angle1,
            radius: radius1
        }), point = new vutils_1.Point(x, y, x1, y1);
