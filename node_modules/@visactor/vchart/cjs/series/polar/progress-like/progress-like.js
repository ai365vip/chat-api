...
const vutils_1 = require("@visactor/vutils"), constant_1 = require("../../../constant"), scale_1 = require("../../../util/scale"), polar_1 = require("../polar"), vrender_core_1 = require("@visactor/vrender-core"), constant_2 = require("./constant"), vutils_extension_1 = require("@visactor/vutils-extension");

class ProgressLikeSeries extends polar_1.PolarSeries {
    constructor() {
        super(...arguments), this._supportStack = !0, this._arcGroupMark = null, this._getAngleValueStart = datum => {
            ...
            if ((null == tickMask ? void 0 : tickMask.forceAlign) && this._isTickMaskVisible(axis)) {
                const originValue = datum[this._stack ? constant_1.STACK_FIELD_START : constant_1.SEGMENT_FIELD_START], subTickData = this._getAngleAxisSubTickData(axis), step = subTickData[1].value - subTickData[0].value, offsetAngle = (0, 
                vutils_1.degreeToRadian)(tickMask.offsetAngle);
                let pos;
                if ((0, vutils_1.isValid)(originValue)) {
                    const index = (0, vutils_extension_1.binaryFuzzySearch)(subTickData, (tick => tick.value - originValue)), targetIndex = originValue > subTickData[index].value - step / 2 ? Math.min(index, subTickData.length - 1) : index > 0 ? index - 1 : void 0;
            ...
            const axis = this._getAngleAxis(), {tickMask: tickMask} = this._spec;
            if ((null == tickMask ? void 0 : tickMask.forceAlign) && this._isTickMaskVisible(axis)) {
                const originValue = datum[this._stack ? constant_1.STACK_FIELD_END : this._angleField[0]], subTickData = this._getAngleAxisSubTickData(axis), step = subTickData[1].value - subTickData[0].value, offsetAngle = (0, 
                vutils_1.degreeToRadian)(tickMask.offsetAngle), index = (0, vutils_extension_1.binaryFuzzySearch)(subTickData, (tick => tick.value - originValue)), targetIndex = originValue > subTickData[index].value - step / 2 ? Math.min(index, subTickData.length - 1) : index > 0 ? index - 1 : void 0;
                let pos;
    ...
    setAttrFromSpec() {
        ...
        this._startAngle = (0, vutils_1.isValid)(startAngle) ? (0, vutils_1.degreeToRadian)(startAngle) : constant_1.POLAR_START_RADIAN;
        const endAngle = null !== (_c = this._spec.endAngle) && void 0 !== _c ? _c : null == chartSpec ? void 0 : chartSpec.endAngle;
        this._endAngle = (0, vutils_1.isValid)(endAngle) ? (0, vutils_1.degreeToRadian)(endAngle) : constant_1.POLAR_END_RADIAN, 
    ...
    _getAngleValueStartWithoutMask(datum) {
        if (this._stack) {
            const value = (0, scale_1.valueInScaleRange)(this.angleAxisHelper.dataToPosition([ datum[constant_1.STACK_FIELD_START] ]), this.angleAxisHelper.getScale(0));
    ...
    _getAngleValueEndWithoutMask(datum) {
        if (this._stack) {
            const value = (0, scale_1.valueInScaleRange)(this.angleAxisHelper.dataToPosition([ datum[constant_1.STACK_FIELD_END] ]), this.angleAxisHelper.getScale(0));
            if ((0, vutils_1.isValidNumber)(value)) return value;
        }
    ...
    _initArcGroupMarkStyle() {
        ...
        }, "normal", constant_1.AttributeLevel.Series), this._arcGroupMark.setInteractive(!1);
    }
    _getAngleAxis() {
...
exports.ProgressLikeSeries = ProgressLikeSeries, ProgressLikeSeries.mark = constant_2.progressLikeSeriesMark;
