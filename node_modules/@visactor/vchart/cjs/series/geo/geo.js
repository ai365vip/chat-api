...
const type_1 = require("../interface/type"), base_series_1 = require("../base/base-series"), vutils_1 = require("@visactor/vutils"), constant_1 = require("../../constant");
...
class GeoSeries extends base_series_1.BaseSeries {
    ...
    nameToPosition(datum) {
        ...
        if ((0, vutils_1.isNil)(name)) return null;
    ...
    initStatisticalData() {
        if (super.initStatisticalData(), this._mapViewData) {
            const viewDataName = `${constant_1.PREFIX}_series_${this.id}_mapViewDataStatic`;
