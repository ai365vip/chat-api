...
class AreaSeries extends cartesian_1.CartesianSeries {
    ...
    initMarkStyle() {
        var _a, _b, _c, _d, _e;
        const userCurveType = null !== (_c = null === (_b = null === (_a = this.getSpec().area) || void 0 === _a ? void 0 : _a.style) || void 0 === _b ? void 0 : _b.curveType) && void 0 !== _c ? _c : null === (_e = null === (_d = this.getSpec().line) || void 0 === _d ? void 0 : _d.style) || void 0 === _e ? void 0 : _e.curveType, curveType = userCurveType === interpolate_1.DEFAULT_SMOOTH_INTERPOLATE ? this._direction === space_1.Direction.vertical ? "monotoneX" : "monotoneY" : userCurveType, areaMark = this._areaMark;
        areaMark && (this._direction === space_1.Direction.vertical ? this.setMarkStyle(this._areaMark, {
    ...
    initAnimation() {
        ...
        utils_1.userAnimationConfig)(type_1.SeriesMarkNameEnum.line, this._spec, this._markAttributeContext))), 
        ...
        utils_1.userAnimationConfig)(type_1.SeriesMarkNameEnum.area, this._spec, this._markAttributeContext))), 
        this._symbolMark) {
