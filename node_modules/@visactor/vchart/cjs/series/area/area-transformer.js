...
const vutils_1 = require("@visactor/vutils"), interface_1 = require("../interface"), line_mixin_transformer_1 = require("../mixin/line-mixin-transformer"), util_1 = require("../../util");

class AreaSeriesSpecTransformer extends line_mixin_transformer_1.LineLikeSeriesSpecTransformer {
    _transformLabelSpec(spec) {
        var _a, _b, _c;
        super._transformLabelSpec(spec), this._addMarkLabelSpec(spec, interface_1.SeriesMarkNameEnum.area, "areaLabel", "initLineLabelMarkStyle", void 0, !0);
        !1 !== (null === (_a = spec.point) || void 0 === _a ? void 0 : _a.visible) && !1 !== (null === (_c = null === (_b = spec.point) || void 0 === _b ? void 0 : _b.style) || void 0 === _c ? void 0 : _c.visible) || this._addMarkLabelSpec(spec, interface_1.SeriesMarkNameEnum.area);
    }
