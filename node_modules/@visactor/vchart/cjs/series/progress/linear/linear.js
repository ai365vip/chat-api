...
class LinearProgressSeries extends cartesian_1.CartesianSeries {
    ...
    initAnimation() {
        ...
        utils_1.userAnimationConfig)(type_1.SeriesMarkNameEnum.progress, this._spec, this._markAttributeContext))), 
        ...
        utils_1.userAnimationConfig)(type_1.SeriesMarkNameEnum.track, this._spec, this._markAttributeContext)));
    }
    initTooltip() {
