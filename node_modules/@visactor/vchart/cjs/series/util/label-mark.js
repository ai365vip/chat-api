...
const space_1 = require("../../typings/space"), constant_1 = require("../../constant");

function setRectLabelPos(component, labelMark, position, offset, x, x1, y, y1, direction) {
    component.setMarkStyle(labelMark, {
        textAlign: datum => {
            if (direction() === space_1.Direction.vertical) return "center";
        ...
        textBaseline: datum => {
            if (direction() === space_1.Direction.horizontal) return "middle";
        ...
        x: datum => {
            ...
            if (d === space_1.Direction.vertical) return (_x + _x1) / 2;
        ...
        y: datum => {
            ...
            if (d === space_1.Direction.horizontal) return (_y + _y1) / 2;
