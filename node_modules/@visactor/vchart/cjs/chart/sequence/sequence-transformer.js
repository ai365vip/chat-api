...
const vutils_1 = require("@visactor/vutils"), vdataset_1 = require("@visactor/vdataset"), base_1 = require("../base"), series_1 = require("../../series"), util_1 = require("../../util"), constant_1 = require("../../component/data-zoom/constant"), scroll_bar_1 = require("../../constant/scroll-bar");
            ...
            if ([ series_1.SeriesTypeEnum.bar, series_1.SeriesTypeEnum.line, series_1.SeriesTypeEnum.area, series_1.SeriesTypeEnum.dot ].includes(seriesSpec.type)) {
                if (elements.push({
                    ...
                    scrollBar.push(Object.assign({
                        ...
                        filterMode: constant_1.IFilterMode.axis,
                        regionIndex: region.length - 1,
