...
const type_1 = require("../mark/interface/type"), vdataset_1 = require("@visactor/vdataset");
...
class Factory {
    ...
    static createMark(markType, name, options) {
        ...
        return markInstance.type === type_1.MarkTypeEnum.group && markInstance.setInteractive(!1), 
        markInstance;
    }
