...
Object.defineProperty(exports, "__esModule", {
    value: !0
}), exports.parseCollectionMarkAttributes = exports.getLinePointsFromSegments = exports.getLineSegmentConfigs = void 0;
...
function getLineSegmentConfigs(items, points, element) {
    ...
    return items.forEach(((item, index) => {
        ...
        const res = (0, transform_1.transformAttributes)(enums_1.GrammarMarkType.line, parseCollectionMarkAttributes(entry.attrs), element);
...
exports.parseCollectionMarkAttributes = parseCollectionMarkAttributes;
