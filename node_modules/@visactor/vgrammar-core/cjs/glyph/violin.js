...
const vutils_1 = require("@visactor/vutils"), factory_1 = require("../core/factory"), graphic_1 = require("../graph/mark/graphic"), vgrammar_util_1 = require("@visactor/vgrammar-util"), defaultDensitySize = 30, computeViolinPoints = (density, densitySize, scale, config) => {
    ...
    }))), (0, graphic_1.registerGlyphGraphic)(), (0, graphic_1.registerPolygonGraphic)(), 
    (0, graphic_1.registerRuleGraphic)(), (0, graphic_1.registerRectGraphic)(), (0, 
