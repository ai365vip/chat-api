...
const vgrammar_util_1 = require("@visactor/vgrammar-util"), differ_1 = require("../../graph/mark/differ"), stack = (options, data) => {
    var _a;
    ...
    const groupedData = (0, differ_1.groupData)(data, (0, vgrammar_util_1.field)("dimension"));
