export const CHANNEL_OPTIONS = [
    ...
    { key: 30, text: 'Groq', value: 30, color: 'Groq' , label: 'Groq'},
    { key: 31, text: '百川大模型', value: 31, color: 'orange' , label: '百川大模型'},
    { key: 32, text: 'MiniMax', value: 32, color: 'red' , label: 'MiniMax'},
    { key: 33, text: 'Mistral', value: 33, color: 'orange' , label: 'Mistral'},
    { key: 34, text: 'Ollama', value: 34, color: 'black' , label: 'Ollama'},
    { key: 35, text: '零一万物', value: 35, color: 'green', label: '零一万物'},
    ...
    {key: 29, text: 'Stability SD', value: 29, color: 'teal', label: 'Stability SD'},
